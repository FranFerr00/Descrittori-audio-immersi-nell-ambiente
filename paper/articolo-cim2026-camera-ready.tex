...
\begin{figure*}
 ...
 \caption{Il clarinetto contrabbasso nel terzo esperimento: per ogni campione (colonna: le due campane, originale e custom, nei due orientamenti del microfono) il centroide medio a banda piena agli otto microfoni; le linee uniscono lo stesso microfono fra i campioni (numero e colore del punto: vedi legenda).}
...
Un secondo segno lo lascia la campana sul Do tenuto. La kurtosis, indifferente all'onda sui cluster, sul Do sale da circa 21 al nodo di pressione a quasi 60 al ventre quando la campana custom è puntata di fronte alla capsula, mentre con la campana originale, o con la stessa campana e capsula ruotata, resta fra 10 e 13. Occorre il concorso di tre condizioni (la nota singola, il ventre dove la fondamentale è forte, la campana custom): la kurtosis indica qui l'interazione fra campana, luogo e microfono, più che la distanza.
