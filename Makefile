...
.PHONY: all wav segnali segnali-30db recs cataloghi temporali tabelle desc nuovi zscore zscore-plot clean clean-tabelle clean-wav clean-segnali clean-segnali-30db clean-recs clean-cataloghi clean-temporali clean-desc clean-nuovi clean-zscore
